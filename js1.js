...
function pedirusuario() {
  ...
  pass = prompt('ingrese contrasena')
}
...
const pedidodedatos= function() {
  ...
  while (true) {
  tel =prompt('Ingrese un número de telefono de contacto')
  if (tel.length == 10) {
    break
   } else {
    alert('Por favor, ingrese un numero de telefono velido (10 digitos)')
   } 
  }
...
//ingreso a la pagina
while (true) {
  ingreso = prompt('Bienvenido a Tourism SA.' + '\n' + '¿Posee una cuenta en nuestra pagina? (SI/NO)').toLowerCase()
  if (ingreso == 'si') {
    pedirusuario()
    ...
    alert('credenciales invalidas')
      ...
      '\n' + 'ESTUDIOS:'+ estudios )
      CrearNuevoPerfil()
      alert('Perfecto, tu postulacion quedo registrada!. Nos estaremos contactando con vos, gracias por elegirnos!')
      console.log(aspirantes)
      break
  }  else {
    alert('Respuesta no valida. Por favor, responda con SI o NO.');
  }
}
